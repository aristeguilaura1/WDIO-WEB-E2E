export const config: WebdriverIO.Config = {
    ...
    cucumberOpts: {
        ...
        require: [
            './features/step-definitions/blazedemo-csv.steps.ts'
        ],
    ...
    onComplete: async function(exitCode, config, capabilities, results) {
        ...
        try {
            ...
            console.log('⚠️ Failed to generate Allure report automatically');
            console.log('💡 You can generate it manually with: npm run allure:generate');
        }
    },
    /**
